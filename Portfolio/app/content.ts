export const portfolio = {
  ...
  quantProjects: [
    ...
    { title: "Limit Order Book Simulator", summary: "Price-time-priority simulator with a live Alpaca IEX top-quote endpoint; book depth remains explicitly simulated.", technologies: ["Python", "Flask", "Alpaca"], github: "https://github.com/aaraven99/limit-order-book-simulator" },
    ...
    { title: "Monte Carlo Risk Lab", summary: "Vectorized option and risk simulation with optional live yfinance calibration.", technologies: ["Python", "NumPy", "yfinance"], github: "https://github.com/aaraven99/monte-carlo-risk-lab" },
    ...
    { title: "Real-Time Market Dashboard", summary: "Live yfinance intraday stream, price statistics, and moving averages through a local credential-safe relay.", technologies: ["React", "TypeScript", "yfinance"], github: "https://github.com/aaraven99/realtime-market-dashboard" },
  ],
  skills: [
